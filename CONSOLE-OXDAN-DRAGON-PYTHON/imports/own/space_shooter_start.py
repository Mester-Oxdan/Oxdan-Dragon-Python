...
def space_shooter_start():
	...
	class Missile(pygame.sprite.Sprite):
		...
		def __init__(self, x, y):
			pygame.sprite.Sprite.__init__(self)
			self.rect = pygame.locals.Rect(x - 2, y, 4, 8)
	...
	while running:
		...
		if keys[pygame.locals.K_LEFT] and player.rect.left > 0:
			player.x -= 2
