...
def Commands():
    ...
    if imports.own.will_go_to_start.x.lower() == "--help" or imports.own.will_go_to_start.x.lower() == "-help" or imports.own.will_go_to_start.x.lower() == "help" or imports.own.will_go_to_start.x.lower() == "-h": # --help (+)
            ...
            sleep(0.01)
            print("phone_search - searching location by entered phone number (for location on google maps use (https://www.maps.ie/coordinates.html))") # phone_search (+)
            sleep(0.01)
            print("mimikatz - using mimikatz commands") # mimikatz (+)
            sleep(0.01)
            print("john - using john the ripper commands") # john (+)
            sleep(0.01)
            print("nmap - using nmap commands") # nmap (+)
            sleep(0.01)
            ...
            sleep(0.01)
            print("5) Youtube (https://www.youtube.com/@Oxdan_products)") # 5) Youtube (+)
            sleep(0.01)
            print("6) TikTok (www.tiktok.com/@oxdan_products.)") # 6) TikTok (+)
            sleep(0.01)
            ...
            sleep(0.01)
            print("10) For Sponsoring/Donations (4403 9352 3234 1307)") # 10) Sponsoring/Donations (+)
            sleep(0.01)
            print("11) ")
            sleep(0.01)
