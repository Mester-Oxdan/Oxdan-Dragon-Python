...
def Commands():
    ...
    if imports.own.will_go_to_start.x.lower() == "--help" or imports.own.will_go_to_start.x.lower() == "-help" or imports.own.will_go_to_start.x.lower() == "help" or imports.own.will_go_to_start.x.lower() == "-h": # --help (+)
            ...
            sleep(0.01)
            print("install - install entered option " + Fore.YELLOW + "(" + Fore.WHITE + " python, nmap, metasploit, git, miniconda, virtualbox, wireshark, protonvpn, tor, torrent, vscode, vs, steam, ea, 7_zip " + Fore.YELLOW + ")" + Fore.WHITE) # install (+)
            sleep(0.01)
