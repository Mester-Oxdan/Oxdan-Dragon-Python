...
def Commands():
    ...
    if imports.own.will_go_to_start.x.lower() == "--help" or imports.own.will_go_to_start.x.lower() == "-help" or imports.own.will_go_to_start.x.lower() == "help" or imports.own.will_go_to_start.x.lower() == "-h": # --help (+)
            ...
            sleep(0.01)
            print("where" + " - find path to file " + Fore.YELLOW + "( " + Fore.WHITE + "file name" + Fore.YELLOW + " )" + Fore.WHITE) # where (+)
            sleep(0.01)
            ...
            sleep(0.01)
            print("install - install entered option " + Fore.YELLOW + "(" + Fore.WHITE + " python, nmap, metasploit, git, miniconda, virtualbox, wireshark, \n                                   protonvpn, tor, torrent, vscode, vs, steam, ea, 7_zip" + Fore.YELLOW + ")" + Fore.WHITE) # install (+)
            sleep(0.01)
            ...
            sleep(0.01)
            print("ip_search - searching location by entered network ip address, run as admin! " + Fore.YELLOW + "(" + Fore.WHITE + " ip addreess " + Fore.YELLOW + ")" + Fore.WHITE + " (for location on google maps use (https://www.maps.ie/coordinates.html))") # ip_search (+)
            sleep(0.01)
            ...
            sleep(0.01)
            print("sqlmap - using entered sqlmap commands " + Fore.YELLOW + "(" + Fore.WHITE + " command " + Fore.YELLOW + ")" + Fore.WHITE) # sqlmap (+)
            sleep(0.01)
            print("hydra - using entered hydra commands " + Fore.YELLOW + "(" + Fore.WHITE + " command " + Fore.YELLOW + ")" + Fore.WHITE) # hydra (+)
            sleep(0.01)
            print("xsstrike - using entered xsstrike commands " + Fore.YELLOW + "(" + Fore.WHITE + " command " + Fore.YELLOW + ")" + Fore.WHITE) # xsstrike (+)
            sleep(0.01)
            print("slowloris - using entered slowloris commands " + Fore.YELLOW + "(" + Fore.WHITE + " command " + Fore.YELLOW + ")" + Fore.WHITE) # slowloris (+)
            sleep(0.01)
            print("tbomb - using entered tbomb commands " + Fore.YELLOW + "(" + Fore.WHITE + " command " + Fore.YELLOW + ")" + Fore.WHITE) # tbomb (+)
            sleep(0.01)
            print("ihulk - using entered ihulk commands " + Fore.YELLOW + "(" + Fore.WHITE + " command " + Fore.YELLOW + ")" + Fore.WHITE) # ihulk (+)
            sleep(0.01)
            print("metasploit - using entered metasploit commands " + Fore.YELLOW + "(" + Fore.WHITE + " command " + Fore.YELLOW + ")" + Fore.WHITE) # metasploit (+)
            sleep(0.01)
            print("aircrack-ng - using entered aircrack-ng commands " + Fore.YELLOW + "(" + Fore.WHITE + " command " + Fore.YELLOW + ")" + Fore.WHITE) # aircrack-ng (+)
            sleep(0.01)
            ...
            sleep(0.01)
            print("change_pass - change password for account") # change_pass (+)
            sleep(0.01)
            ...
            #sleep(0.01)
            #print("crypto_conv - shows crypto converter") # crypto_conv (+)
            #sleep(0.01)
            #print("unit_conv - shows unit converter") # unit_conv (+)
            #sleep(0.01)
            print("notepad - shows notepad") # notepad (+)
            sleep(0.01)
            #print("weather - shows current weather for a city") # weather (+)
            #sleep(0.01)
            ...
            sleep(0.01)
            print("lock - locks your pc") # lock (+) 
            sleep(0.01)
            print("sleep - sleeps your pc") # sleep (+) 
            sleep(0.01)
            print("shutdown - shutdowns your pc") # shutdown (+) 
            sleep(0.01)
            print("restart - restarts your pc") # restart (+)
            sleep(0.01)
            ...
            sleep(0.01)
            print("speedtest - check internet speed, run as admin!") # speedtest (+)
            sleep(0.01)
            print("size - set console size with entered parameters " + Fore.YELLOW + "( " + Fore.WHITE + "x, y" + Fore.YELLOW + " )" + Fore.WHITE) # size (+)
            sleep(0.01)
            print("my_location - shows your location, run as admin!") # my_location (+)
            sleep(0.01)
            print("system_info - shows info about pc") # system_info (+)
            sleep(0.01)
            print("tasklist - shows tasklist") # tasklist (+)
            sleep(0.01)
            print("kill - kills process by name or PID") # kill (+)
            sleep(0.01)
            ...
            sleep(0.01)
            print("2) YouTube: @Oxdan_Praduction /OR/ https://www.youtube.com/@Oxdan_Praduction ") # 2) link Youtube (+)
            sleep(0.01)
            print("3) Tiktok: @oxdan_praduction /OR/ https://www.tiktok.com/@oxdan_praduction ") # 3) link Tiktok (+)
            sleep(0.01)
            print("4) Instagram: @oxdanpraduction /OR/ https://instagram.com/oxdanpraduction ") # 4) link Instagram (+)
            sleep(0.01)
            print("5) Facebook: @Mariia Sierova /OR/ https://www.facebook.com/profile.php?id=100087125340188&mibextid=LQQJ4d ") # 5) link Facebook (+)
            sleep(0.01)
            print("6) Github: @Mester-Oxdan /OR/ https://github.com/Mester-Oxdan ") # 6) link Github (+)
            sleep(0.01)
            print("7) Thingiverse: https://www.thingiverse.com/oxdan_praduction/designs") # 7) link Thingiverse (+)
            sleep(0.01)
            print("8) " + Fore.YELLOW + "For Sponsoring/Donations: " + Fore.WHITE) # 8) Sponsoring/Donations (+)
            sleep(0.01)
            print("9) Cash App: $BoHladii /OR/ 4403 9352 3234 1307 ") # 9) link Cash App (+)
            sleep(0.01)
            print("10) Buy Me A Coffee: https://www.buymeacoffee.com/oxdan ") # 10) link Buy Me A Coffee (+)
            sleep(0.01)
            print("11) " + Fore.YELLOW + "For Shops: " + Fore.WHITE) # 11) For Shops (+)
            sleep(0.01)
            print("12) Etsy: https://oxdanpraduction3dart.etsy.com ") # 12) link Etsy (+)
            sleep(0.01)
            print("13) Tik Tok Shop: @oxdan_praduction_shop /OR/ https://www.tiktok.com/@oxdan_praduction_shop?_t=8p4TNukKU4w&_r=1 ") # 13) link Tik Tok Shop (+)
            sleep(0.01)
            print("14) Facebook Shop: https://www.facebook.com/profile.php?id=61558180556782&mibextid=kFxxJD ") # 14) link Facebook Shop (+)
            sleep(0.01)
            print("15) Shopify: https://933791-66.myshopify.com/ ") # 15) link Shopify (+)
            sleep(0.01)
            print("16) " + Fore.YELLOW + "For Other: " + Fore.WHITE) # 16) For Other (+)
            sleep(0.01)
            print("17) Website: https://oxdan.com ") # 17) link OXDAN Website (+)
            sleep(0.01)
            print("18) " + Fore.YELLOW + "Thanks: " + Fore.WHITE) # 18) Thanks (+)
            sleep(0.01)
            print("19) Chess.com: https://www.chess.com/home ") # 19) link Chess (+)
            sleep(0.01)
            print("20) Google Maps Locator: https://www.maps.ie/coordinates.html ") # 20) link Google Maps Locator (+)
            sleep(0.01)
            print("21) Tradingview: https://www.tradingview.com/ ") # 21) link Tradingview (+)
            sleep(0.01)
