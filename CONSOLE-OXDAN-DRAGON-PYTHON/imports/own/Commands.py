...
def Commands():
    ...
    if imports.own.will_go_to_start.x.lower() == "--help" or imports.own.will_go_to_start.x.lower() == "-help" or imports.own.will_go_to_start.x.lower() == "help" or imports.own.will_go_to_start.x.lower() == "-h": # --help (+)
            ...
            sleep(0.01)
            print("3) Github: @Mester-Oxdan /OR/ https://github.com/Mester-Oxdan ") # 1) link Github (+)
            sleep(0.01)
            print("4) Tiktok: @oxdan_praduction /OR/ https://www.tiktok.com/@oxdan_praduction ") # 1) link Tiktok (+)
            sleep(0.01)
            print("5) Instagram: @oxdanpraduction /OR/ https://instagram.com/oxdanpraduction ") # 1) link Instagram (+)
            sleep(0.01)
            print("6) Facebook: @Mariia Sierova /OR/ https://www.facebook.com/profile.php?id=100087125340188&mibextid=LQQJ4d ") # 1) link Facebook (+)
            sleep(0.01)
            print("7) Kwork: @jecob /OR/ https://kwork.com/user/jecob ") # 1) link Kwork (+)
            sleep(0.01)
            print("8) Fiverr: @jecob_567 /OR/ https://www.fiverr.com/jecob_567 ") # 1) link Fiverr (+)
            sleep(0.01)
            print("9) Upwork: https://www.upwork.com/freelancers/~01e296384cd379e73e?viewMode=1&mp_source=share ") # 1) link Upwork (+)
            sleep(0.01)
            print("10) Reddit: https://www.reddit.com/u/detektive-void/s/JyYykvbe9o ") # 1) link Reddit (+)
            sleep(0.01)
            print("11) " + Fore.YELLOW + "For Sponsoring/Donations: " + Fore.WHITE) # 1) Sponsoring/Donations (+)
            sleep(0.01)
            print("12) Cash App: $BoHladii /OR/ 4403 9352 3234 1307 ") # 1) link Cash App (+)
            sleep(0.01)
            print("13) Buy Me A Coffee: https://www.buymeacoffee.com/oxdan ") # 1) link Buy Me A Coffee (+)
            sleep(0.01)
            print("14) " + Fore.YELLOW + "For Shops: " + Fore.WHITE) # 1) For Shops (+)
            sleep(0.01)
            print("15) Etsy: https://oxdanpraduction3dart.etsy.com ") # 1) link Etsy (+)
            sleep(0.01)
            print("16) Tik Tok Shop: @oxdan_praduction_shop /OR/ https://www.tiktok.com/@oxdan_praduction_shop?_t=8p4TNukKU4w&_r=1 ") # 1) link Tik Tok Shop (+)
            sleep(0.01)
            print("17) " + Fore.YELLOW + "For Other: " + Fore.WHITE) # 1) For Other (+)
            sleep(0.01)
            print("18) Website: https://oxdan.com ") # 1) link OXDAN Website (+)
            sleep(0.01)
            print("19) " + Fore.YELLOW + "Thanks: " + Fore.WHITE) # 1) Thanks (+)
            sleep(0.01)
            print("20) Chess.com: https://www.chess.com/home ") # 1) link Chess (+)
            sleep(0.01)
            print("21) Google Maps Locator: https://www.maps.ie/coordinates.html ") # 1) link Google Maps Locator (+)
            sleep(0.01)
