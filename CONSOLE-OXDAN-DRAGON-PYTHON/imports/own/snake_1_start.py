...
def snake_1_start():
                ...
                if check_errors[1] > 0:
                     print(Fore.RED + f'[!] Had {check_errors[1]} errors when initialising game, exiting...' + Fore.WHITE)
                     imports.own.will_go_to_start.main()
                else:
                     print(Fore.GREEN + '[+] Game successfully initialised' + Fore.WHITE)
